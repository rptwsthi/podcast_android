 ...
 */
class TabFragment(parentId: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter.addFragment(CreateFolderFragment(parentID), "FOLDER")
        adapter.addFragment(CreateVideoFragment(parentID), "VIDEO")
        adapter.addFragment(CreateAudioFragment(parentID), "AUDIO")
        adapter.addFragment(CreateTextFragment(parentID), "TEXT")
